        ...
        _res.append(
            {
                ...
                **dict(zip(["kstat", "p"], scipy_stats.kruskal(_g1, _g2))),
    ...
    with tp.teed(
        ...
        for _i, (_ax, (_signif1, _signif2)) in enumerate(
            ...
            for line in _ax.lines:
                ...
                target_y = max(_y.max(), _y.min() * 1.3, _y.min() + 0.7)
                _ax.hlines(target_y, 1, 64, color="gray", ls=":", alpha=0.5)

                pct_change = ((_y[3] - _y[0]) / abs(_y[0])) * 100
                va = {True: "bottom", False: "top"}[
                ...
                pct_change = ((_y[3] - _y[2]) / abs(_y[2])) * 100
                va = "bottom"
