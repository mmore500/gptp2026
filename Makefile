...
release: ${BUILD_DIR}.pdf ${BUILD_DIR}-manuscript.pdf ${BUILD_DIR}-supplement.pdf ${BUILD_DIR}.tex ${BUILD_DIR}-template.zip
...
${BUILD_DIR}-template.zip: tex/Authors/Moreno/Author.tex
	./script/template-zip.sh ${BUILD_DIR}-template.zip
