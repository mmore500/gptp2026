...
The first case study applies best-effort strategies to CPU-based multiprocessing, testing scaling efficiency, runtime quality-of-service, and their robustness to hardware anomalies.
