...
For statistical tests comparing treatments, snapshots were aggregated by replicate by both maximum and median.
For each quality of service statistic we estimate maximum --- which captures effects of extreme-magnitude outliers --- and median --- which better represents typicality --- across these window samples.
