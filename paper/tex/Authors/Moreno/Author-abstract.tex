...
Available processing power, however, is by nature vastly distributed --- a challenge exemplified by emerging next-generation AI/ML hardware accelerator platforms.
...
Such constraints, compounded by inevitable hardware anomalies at scale, may motivate partial relaxations of the traditional deterministic computing paradigm.
...
The first case study applyies best-effort strategies to CPU-based multiprocessing, testing scaling efficiency, runtime quality-of-service, and their robustness to hardware anomalies.
The second case study examines WSE-based evolution simulations, testing best-effort strategies to track population history under constraints in memory, bandwidth, and data fidelity.
In sum, cataloging potential forms and scopes of best-effort relaxation, we argue that digital evolution is uniquely positioned to contribute in exploring post-deterministic HPC.
