...
Any further beneficial mutations accrued past this point were revertehttps://github.com/mmore500/hstrat-reconstruction-algod to the bound.
...
For a some trials, we applied additional runtime data logging in our simulations to track time series data of mutator allele prevalence.
...
% To assess the efficacy of hardware accelerator resources in expediting our simulations, we collected timings of runtime dIn addition to simstepuration from our simulation experiments.
...
Materials are available via the Open Science Framework at\url{https://osf.io/ymaf8} \cite{foster2017open}.
...
WSE hardware was Cerebras CS-2 with Cerebras SDK v1.0.0 \cite{buitrago2021neocortex}.
