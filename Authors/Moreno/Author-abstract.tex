...
The first case study applies best-effort CPU-cluster multiprocessing to a digital multicell workload, which provides 92\% scaling efficiency up to 64 processes ($2.1\times$ speedup) and exhibits robust median quality of service, even under hardware anomalies.
