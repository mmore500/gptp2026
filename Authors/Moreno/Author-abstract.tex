...
For instance, to pack 880,000 processors onto a single chip, the Cerebras Wafer-Scale Engine (WSE) provisions just 48kB of on-device memory per processor, requires multi-hop routing for point-to-point communication, and supports data export only from the chip periphery.
