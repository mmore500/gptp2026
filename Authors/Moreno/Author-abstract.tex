...
Such best-effort approaches, however, necessitate care to maintain reproducibility and mitigate bias.
...
Here, we develop a framework to characterize runtime behavior of best-effort code to screen for runtime anomalies and apply it to two case studies of best-effort computing approaches in digital evolution projects.
...
The second case study explores best-effort digital evolution on the Cerebras Wafer-Scale Engine, focusing in particular on tracking evolution under constraints memory, bandwidth, and data loss arising from hardware faults.
Cataloging potential scopes and forms of best-effort relaxations, we argue that digital evolution is uniquely positioned to lead exploration of post-deterministic HPC and, indeed, already has a rich history of doing so.
