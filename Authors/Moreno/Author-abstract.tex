...
Such processing power, however, is by nature vastly distributed --- a challenge epitomized by emerging AI/ML hardware accelerator platforms.
...
Here, we develop a conceptual framework for screening for potential issues in reproducibility and bias and explore two case studies of best-effort computing approaches in digital evolution projects.
The first, leveraging CPU-based multiprocessing to support experiments studying major transitions in evolution, develops metrics for quality-of-service, explores how they scale and are distributed within processor topology, and how they respond to hardware anomolies.
The second focuses on best-effort data collection from the the Cerebras Wafer-Scale Engine, demonstrating how best-effort approaches can be used to effectively work within constraints of on-chip memory, host-device bandwidth, and even hardware faults rendering certain data unavailable.
% Finally, we propose a roadmap for further progress in this area,
Digital evolution is uniquely positioned to explore such possibilities and, indeed, has a rich history of doing so establish a roadmap.
