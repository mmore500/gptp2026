...
Such constraints, compounded by inevietable hardware anomolies at scale, may make worthwhile partial relaxations of the traditional deterministic computing paradigm.
...
The first case study, applying best-effort strategies to CPU-based multiprocessing, tests scaling efficiency, runtime quality-of-service, and robustness of both to hardware anomolies.
