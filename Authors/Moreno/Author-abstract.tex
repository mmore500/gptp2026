...
Available processing power, however, is by nature vastly distributed --- a challenge epitomized by emerging AI/ML hardware accelerator platforms.
...
To work within such constraints, partial relaxations of traditional deterministic computing paradigms may become a worthwhile trade-off.
...
Here, we develop a framework for instrumenting best-effort code to screen for runtime anomalies and explore two case studies of best-effort computing approaches in digital evolution projects.
The first case study, leveraging CPU-based multiprocessing to support experiments studying major transitions in evolution, explores how performance benefits scale, how best-effort quality-of-service vary, and how both respond to hardware anomolies.
The second case study focuses on best-effort data collection from the the Cerebras Wafer-Scale Engine, demonstrating how best-effort approaches can be used to effectively work within constraints of on-chip memory, host-device bandwidth, and even hardware faults rendering certain data unavailable.
Cataloging potential types of best-effort relaxations and scopes of best-effort strategies, we argue that digital evolution is uniquely positioned to lead exploration of best-effort computing strategies for high-performance computing and, indeed, already has a rich history of doing so.
